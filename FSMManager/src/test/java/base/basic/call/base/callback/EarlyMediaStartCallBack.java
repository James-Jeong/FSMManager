...
public class EarlyMediaStartCallBack extends CallBack {
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.info("EarlyMediaStartCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}", callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName());
