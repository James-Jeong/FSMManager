...
public class OfferNegoCallBack extends CallBack {
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.info("OfferNegoCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}", callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName());
