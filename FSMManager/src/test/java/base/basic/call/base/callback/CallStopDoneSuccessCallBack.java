...
public class CallStopDoneSuccessCallBack extends CallBack {
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.info("CallStopDoneSuccessCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}", callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName());
