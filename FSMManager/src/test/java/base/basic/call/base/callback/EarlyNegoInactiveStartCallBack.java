...
/**
 * @class public class EarlyNegoInactiveStartCallBack extends CallBack
 * @brief EarlyNegoInactiveStartCallBack class
 */
public class EarlyNegoInactiveStartCallBack extends CallBack {

    private static final Logger logger = LoggerFactory.getLogger(EarlyNegoInactiveStartCallBack.class);

    public EarlyNegoInactiveStartCallBack(String name) {
        super(name);
    }
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.debug("EarlyNegoInactiveStartCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}", callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName());
