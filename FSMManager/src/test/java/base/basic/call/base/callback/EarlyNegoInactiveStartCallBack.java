...
public class EarlyNegoInactiveStartCallBack extends CallBack {
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.info("EarlyNegoInactiveStartCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}",
                callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName()
        );
