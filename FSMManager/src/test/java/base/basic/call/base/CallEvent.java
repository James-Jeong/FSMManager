...
public class CallEvent {
    ...
    public static final String EARLY_MEDIA_STOP_EVENT = "early_media_stop";
    ...
    public static final String CALL_STOP_DONE_FAIL_EVENT = "call_stop_done_fail";
    ...
    public static final String EARLY_MEDIA_NEGO_START_EVENT = "early_media_nego_start";
