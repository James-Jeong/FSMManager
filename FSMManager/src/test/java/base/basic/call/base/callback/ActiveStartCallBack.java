 ...
 */
public class ActiveStartCallBack extends CallBack {

    private static final Logger logger = LoggerFactory.getLogger(ActiveStartCallBack.class);

    public ActiveStartCallBack(String name) {
        super(name);
    }
    ...
    public Object callBackFunc(Object... object) {
        ...
        logger.debug("ActiveStartCallBack: callId={}, fromNo={}, toNo={}, mediaStateUnitName={}", callInfo.getCallId(), callInfo.getFromNo(), callInfo.getToNo(), callInfo.getMediaStateUnitName());
